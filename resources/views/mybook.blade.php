                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="mu-author-info">
                                            <h3>Harry Potter</h3>
                                            <ul>
                                                <li><p>Author : John Doe</p></li>
                                                <li><p>Total Page : 200 page</p></li>
                                                <li><p>Originally published: June 26, 1997</p></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mu-author-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <h3>Becoming</h3>
                                            <ul>
                                                <li><p>Author : Michelle Obama</p></li>
                                                <li><p>Total Page : 448 page</p></li>
                                                <li><p>Originally published: November 13, 2018</p></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
