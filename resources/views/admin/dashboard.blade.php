...
<head>
    ...
    <!-- Custom CSS -->
    <link href="/css/admin/plugins/bower_components/chartist/dist/chartist.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/css/admin/plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css">
    <!-- Custom CSS -->
                        ...
                        <div class="card white-box p-0">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row p-3 mt-0">
                                    <div class="p-2"><img src="/css/admin/plugins/images/users/varun.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="/css/admin/plugins/images/users/genu.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="/css/admin/plugins/images/users/ritesh.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text ps-2 ps-md-3 w-100">
                            ...
                            <div class="card-body">
                                <ul class="chatonline">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="/css/admin/plugins/images/users/genu.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="/css/admin/plugins/images/users/ritesh.jpg" alt="user-img" class="img-circle">
                                            <div class="ms-2">
