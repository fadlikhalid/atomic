            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">The latest inserted Book</h3>
                            </div>
                            <div class="table-responsive">
                                <table class="table no-wrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="txt-oflo">{{$latestbook->book_name}}</td>
                                            <td>{{$latestbook->book_file}}</td>
                                            <td class="txt-oflo">{{$latestbook->genre}}</td>
                                            <td><span class="text-success">{{$latestbook->author}}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">The latest inserted User</h3>
                            </div>
                            <div class="table-responsive">
                                <table class="table no-wrap">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="txt-oflo">{{$latestuser->name}}</td>
